...
test("renderIndex shows verified count", () => {
  const packs = [
    { id: "a", domain: "a", name: "A", description: "", version: "1", language: "en", project_type: "backend",
      requirements: 1, useCases: 1, aggregates: 0, events: 0, scenarios: 1, lintStatus: "pass", lintMessages: [] },
    { id: "b", domain: "b", name: "B", description: "", version: "1", language: "en", project_type: "backend",

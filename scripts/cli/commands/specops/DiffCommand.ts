 ...
 *   2. Compare the temp dir to the project copy — `diffDirs` reduces both to
 *      content hashes, which is enough because render is deterministic for a
 *      fixed pack version + vars

...
| **GATE-G6**           | **Adopción simulada**: tres repos brownfield de dominios distintos llevados a L1–L2 por agentes aislados, cada uno con su assessment medido                                  | Trabajo de campo simulado | Nuevo, [ADR-0025](../docs/specs/adr/0025-simulated-adoption-is-not-external-adoption.md). **No cierra G3** y no mueve la 1.0 |

...
npx @rtexido/specgate specops sync --project-dir ./smart-parking

# Bump only one pack to a new tag (updates the lockfile)
npx @rtexido/specgate specops sync \
  --project-dir ./smart-parking \
  --pack parking-management/backend \
  --pack-version v0.2.0

# Preview without writing anything
npx @rtexido/specgate specops sync --project-dir ./smart-parking --dry-run

# Pack always wins — discard local edits
npx @rtexido/specgate specops sync --project-dir ./smart-parking --force

# Never write conflict markers — leave conflicting files untouched
npx @rtexido/specgate specops sync --project-dir ./smart-parking --abort-on-conflict
```
...
npx @rtexido/specgate specops diff \
  --project-dir ./smart-parking \
  --pack-version v0.2.0
```
...
npx @rtexido/specgate init --config ./project.config --out . --force
...
# 3. Verify
npx @rtexido/specgate validate ./smart-parking
